...
def main():
    ...
    # We use the same number of "pre_epochs" and num_premodels" as IID did
    # To decrease train time, we can set smaller "pre_epochs" and "num_premodels (e.g., 200)" 
    ...
    for i in range(num_premodels):
        ...
        optimizer = torch.optim.SGD(net.parameters(), lr=args.lr_net, momentum=0.9, weight_decay=0.001)
