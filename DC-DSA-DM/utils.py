...
from pretrain.networks import MLP, ConvNet, LeNet, AlexNet, AlexNetBN, VGG11, VGG11BN, ResNet18, ResNet18BN_AP, ResNet18BN
import random
...
def get_premodel(model_path="../CIFAR10_pre_res"):
    # index = 0
...
def rand_crop(x, param):
    ...
    if param.Siamese:  # Siamese augmentation:
        ...
        b = translation_x.clone()
        translation_x[:] = b[0]
        c = translation_y.clone()
        translation_y[:] = c[0]
